...
Character SavedCharacter(const std::string& saved_name, int& saved_level, int& saved_wins, int& saved_losses, int& saved_health, int& saved_attack, int& saved_defense, int& saved_magic, int& saved_heal, int& saved_items, int& saved_exp);
